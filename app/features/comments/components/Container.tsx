      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>Comments are a great way to collaborate with your team.</DialogDescription>
          </DialogHeader>
                        ...
                        <div className="flex gap-2">
                          ...
                          <div className="flex flex-col justify-between">
                            <div className="flex gap-3 items-center">
                              <p className="text-medium font-bold">{comment.profiles.full_name}</p>
