...
export const FriendRequest = () => {
  ...
  return (
    <div className="text-white rounded-lg p-6 border border-white space-y-2 shadow-md">
      ...
      <p
        className={`${
          status === "Waiting" ? "text-yellow-500" : status === "Approved" ? "text-green-500" : "text-red-500"
      ...
      {status === "Waiting" ? (
        <div className="flex gap-2">
          <Button onClick={acceptRequestHandler} className="bg-green-600 hover:bg-green-600 hover:opacity-95">
            Accept
          </Button>
