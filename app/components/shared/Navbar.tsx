	...
	const markAsRead = async (notificationId: number) => {
		...
		if (!error) {
			setNotifications((notifications) =>
				notifications.filter((nf) => nf.id !== notificationId)
			);
			...
			toast({
				...
				action: (
					<ToastAction altText='Close this toast!'>Close</ToastAction>
				),
			});
		}
	};
